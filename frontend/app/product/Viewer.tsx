...
export default function Viewer() {
  return (
    ...
    >
      ...
      <directionalLight position={[-5, 2, -3]} intensity={0.5} color="#E4C188" />
      ...
      <Suspense fallback={null}>
        ...
        <Environment resolution={256}>
          <Lightformer intensity={2} position={[0, 4, 2]} scale={[8, 4, 1]} color="#FFF6E2" />
          <Lightformer intensity={1.2} position={[-4, 1, 2]} scale={[3, 6, 1]} color="#E4C188" />
          <Lightformer intensity={1} position={[4, 1, 1]} scale={[3, 6, 1]} color="#FFFFFF" />
          <Lightformer intensity={0.8} position={[0, -3, -2]} scale={[8, 4, 1]} color="#C8A87C" />
        </Environment>
      </Suspense>
