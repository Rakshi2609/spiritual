    ...
    >
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "34px 48px 70px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 70, alignItems: "center" }}>
        <div>
          ...
          <h1 style={{ fontFamily: SERIF, fontSize: 76, lineHeight: 1.0, fontWeight: 500, color: "#2F2820", letterSpacing: "-1px", marginBottom: 26 }}>
      ...
      <section className="reveal" style={{ position: "relative", background: "radial-gradient(900px 500px at 50% 0%, #4A4030 0%, #2F2820 60%)", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 860, margin: "0 auto", padding: "110px 48px", textAlign: "center" }}>
          ...
          <blockquote style={{ fontFamily: SERIF, fontSize: 38, lineHeight: 1.42, fontWeight: 400, fontStyle: "italic", color: "#F6EFE2" }}>&ldquo;My evenings feel sacred now. The amethyst sits by my bed and the whole ritual just... grounds me.&rdquo;</blockquote>
      ...
      <footer style={{ background: "#2F2820", color: "#C7B998" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "60px 48px 40px", display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40 }}>
          <div>
      ...
      <div
        ...
        style={{ position: "fixed", inset: 0, zIndex: 50, pointerEvents: cartOpen ? "auto" : "none", opacity: cartOpen ? 1 : 0, transition: "opacity 0.3s ease", background: "rgba(47,40,32,0.4)" }}
      />
      <aside style={{ position: "fixed", top: 0, right: 0, bottom: 0, width: 400, maxWidth: "92vw", zIndex: 51, background: "#F6EFE2", boxShadow: "-20px 0 60px rgba(47,40,32,0.18)", transform: cartOpen ? "translateX(0)" : "translateX(100%)", transition: "transform 0.34s cubic-bezier(0.4,0,0.2,1)", display: "flex", flexDirection: "column" }}>
        <div style={{ padding: "26px 28px", borderBottom: "1px solid #E3D6BD", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <button onClick={() => setCartOpen(false)} style={{ background: "none", border: "none", cursor: "pointer", fontSize: 22, color: "#6A5F4F", lineHeight: 1 }}>×</button>
        </div>
        ...
        <div style={{ padding: "22px 28px 28px", borderTop: "1px solid #E3D6BD" }}>
          ...
          <button style={{ width: "100%", background: "#3D352A", color: "#F6EFE2", border: "none", cursor: "pointer", fontFamily: SANS, fontSize: "13.5px", letterSpacing: "2px", textTransform: "uppercase", padding: 16, borderRadius: 2 }}>Checkout</button>
